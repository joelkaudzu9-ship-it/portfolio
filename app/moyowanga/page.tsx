  ...
  return (
    <div className="min-h-screen py-20">
      <div className="container-custom">
        {/* Back Button */}
        <Link href="/projects" className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-teal-500 mb-8 transition-colors">
        ...
        <div
          ...
          className="mb-12"
        >
          <span className="text-teal-500 font-semibold">Healthcare Technology Platform</span>
        ...
        <div
          ...
          className="mb-12 p-8 rounded-2xl bg-red-500/10 border border-red-500/20"
        >
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            ...
            <div>
              <Shield className="mx-auto mb-2 text-teal-500" size={28} />
        ...
        >
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
            <Globe className="text-teal-500" /> Multilingual Support
          </h2>
          <div className="flex flex-wrap gap-3 mb-6">
            {languages.map(lang => (
              <span key={lang} className="px-4 py-2 rounded-full bg-teal-500/10 text-teal-500 font-medium">
                {lang}
              </span>
            ))}
          </div>
        ...
        <div
          ...
          className="mb-12 p-8 rounded-2xl bg-gray-50 dark:bg-gray-900/30"
        >
          <h2 className="text-2xl font-bold mb-4">Challenges Overcome</h2>
          <ul className="space-y-2">
            <li className="flex gap-2"><span className="text-teal-500">•</span> Telecom integration and compliance</li>
            <li className="flex gap-2"><span className="text-teal-500">•</span> SMS callback debugging</li>
            <li className="flex gap-2"><span className="text-teal-500">•</span> Sender ID restrictions</li>
            <li className="flex gap-2"><span className="text-teal-500">•</span> Financial limitations</li>
            <li className="flex gap-2"><span className="text-teal-500">•</span> Formal business registration for two-way communication</li>
          </ul>
        </div>
