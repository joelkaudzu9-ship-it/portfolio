      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            Systems <span className="gradient-text-gold">Thinking</span>
          </h1>
        ...
        {/* Core Philosophy */}
        <div className="mb-12 p-8 rounded-2xl bg-gradient-to-r from-teal-500/20 to-amber-500/20 text-center">
          <p className="text-xl font-bold gradient-text-gold mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {principles.map((principle) => (
            ...
            >
              <principle.icon size={40} className="text-amber-500 mb-4" />
        ...
        <div className="p-8 rounded-2xl bg-teal-500/10 border border-teal-500/20">
          ...
          <ul className="space-y-2">
            <li className="flex gap-2"><span className="text-amber-500">✓</span> Respect infrastructure realities</li>
            <li className="flex gap-2"><span className="text-amber-500">✓</span> Prioritize accessibility</li>
            <li className="flex gap-2"><span className="text-amber-500">✓</span> Remain economically practical</li>
            <li className="flex gap-2"><span className="text-amber-500">✓</span> Adapt to multilingual populations</li>
            <li className="flex gap-2"><span className="text-amber-500">✓</span> Solve locally meaningful problems</li>
          </ul>
        </div>
