...
import { 
  ArrowLeft, Upload, Image as ImageIcon, X, Video, Play, Save, 
  Trash2, Plus, Eye, Loader2, CheckCircle, AlertCircle,
...
export default function EditPost() {
  ...
  const removeMedia = (index: number) => {
    ...
    setMessage({ type: 'success', text: 'Media removed' })
  ...
  // Insert markdown with selection support
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-amber-500 text-sm">Loading post...</span>
        </div>
      </div>
    )
  }
          ...
          <div className="rounded-xl bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
              <h3 className="text-base font-semibold flex items-center gap-2">
                ...
                Media Gallery ({mediaGallery.length})
              </h3>
