            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:joelkaudzu9@gmail.com" className="text-accent-gold hover:text-accent-goldLight transition-colors">
                    joelkaudzu9@gmail.com
                  </a>
                </div>
                <div>
                  <p className="text-text-muted text-sm mb-1">Phone</p>
                  <a href="tel:+265983142415" className="text-accent-gold hover:text-accent-goldLight transition-colors">
                    +265 983 142 415
                  </a>
                </div>
                <div>
            ...
            <div className="glass-card p-6">
              ...
              <div className="flex gap-4">
                <a href="https://github.com/joelkaudzu9-ship-it" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg bg-surface border border-border hover:border-accent-gold/30 transition-colors">
                  <svg className="w-5 h-5 text-text-secondary hover:text-accent-gold" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            {submitted ? (
              <div className="text-center py-8">
                <div className="text-5xl mb-4 text-accent-gold">✓</div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 rounded-lg bg-surface border border-border focus:border-accent-gold/50 focus:outline-none transition-colors text-text-primary resize-none"
