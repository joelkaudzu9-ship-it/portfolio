    ...
    <footer className="border-t border-border bg-background/50">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/education" className="text-text-secondary hover:text-accent-gold transition-colors text-sm">Education</Link></li>
              <li><Link href="/leadership" className="text-text-secondary hover:text-accent-gold transition-colors text-sm">Leadership</Link></li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="p-2 rounded-lg bg-surface border border-border hover:border-accent-gold/30 transition-colors"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5 text-text-secondary hover:text-accent-gold transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                aria-label="Email"
              >
                <svg className="w-5 h-5 text-text-secondary hover:text-accent-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-text-muted text-sm">
          ...
          <p className="mt-2 text-xs">Building systems that matter.</p>
        </div>
      </div>
    </footer>
  )
