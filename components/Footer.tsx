      ...
      <div className="container-custom py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 order-1 md:order-2">
            <Link href="/about" className="text-text-secondary hover:text-accent-gold transition-colors text-xs sm:text-sm">
              About
            </Link>
            <Link href="/projects" className="text-text-secondary hover:text-accent-gold transition-colors text-xs sm:text-sm">
              Work
            </Link>
